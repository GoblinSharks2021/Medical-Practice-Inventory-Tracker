...
router.get('/inventory', inventoryController.getAllInventory, (req, res) =>
  res.status(200).json(res.locals.inventory)
);

router.get('/inventory/:id', inventoryController.getInventoryById, (req, res) =>
  res.status(200).json(res.locals.inventoryById.row)
);

router.post('/inventory', inventoryController.addNewInventory, (req, res) =>
  res.status(200).json(res.locals.newInventory)
);

router.delete('/inventory', inventoryController.deleteInventory, (req, res) =>
